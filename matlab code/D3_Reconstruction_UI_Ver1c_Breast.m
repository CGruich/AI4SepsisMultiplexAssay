...
[pos_amp,radii_amp] = imfindcircles(Amp,[100,300],'ObjectPolarity','bright','Sensitivity',0.85);
[pos_phase,radii_phase] = imfindcircles(I,[100,300],'ObjectPolarity','bright','Sensitivity',0.85);
...
viscircles(pos_amp,radii_amp,'EdgeColor','w');
