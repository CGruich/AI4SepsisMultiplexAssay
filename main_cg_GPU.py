import argparse
import json
from utils import action_functions
...
if __name__ == '__main__':
    ...
    parser.add_argument(
        ...
        help='choose one of: find_mser_params, train_region_classifier, classify_regions, bayesian_optimize_region_classifier, train_code_classifier, bayesian_optimize_code_classifier',
    )
    parser.add_argument(
        '--pipeline_inputs',
        type=str,
