...
These notebooks are the notebooks used to train the models for MIDAS, as well as perform the Bayesian hyperparameter search of these models.

These notebooks are ordered (1) onwards in the intended order to reproducibly train the models.
